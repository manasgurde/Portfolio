...
export default function HeroIntro() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen z-10 pointer-events-none relative">
      <div className="absolute top-8 w-full px-4 md:px-16 flex justify-center md:justify-end gap-3 md:gap-6 pointer-events-auto z-50 flex-wrap">
        <a 
          href="https://github.com/manasgurde" 
          target="_blank" 
          rel="noreferrer" 
          className="flex items-center gap-1.5 md:gap-2 px-3 py-2 md:px-5 md:py-2.5 rounded-full bg-[#24292e]/80 border border-white/10 hover:border-[#24292e] hover:bg-[#24292e] text-white transition-all shadow-[0_0_15px_rgba(36,41,46,0.5)] backdrop-blur-md text-xs md:text-sm font-medium"
        >
          <svg className="w-4 h-4 md:w-[18px] md:h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
          GitHub
        </a>
        <a 
          href="https://www.linkedin.com/in/manas-gurde-b39596408" 
          target="_blank" 
          rel="noreferrer" 
          className="flex items-center gap-1.5 md:gap-2 px-3 py-2 md:px-5 md:py-2.5 rounded-full bg-[#0077b5]/80 border border-white/10 hover:border-[#0077b5] hover:bg-[#0077b5] text-white transition-all shadow-[0_0_15px_rgba(0,119,181,0.5)] backdrop-blur-md text-xs md:text-sm font-medium"
        >
          <svg className="w-4 h-4 md:w-[18px] md:h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
          LinkedIn
        </a>
        <a 
          href="/resume.pdf" 
          target="_blank" 
          rel="noreferrer" 
          className="flex items-center gap-1.5 md:gap-2 px-3 py-2 md:px-5 md:py-2.5 rounded-full bg-emerald-600/80 border border-emerald-500/50 hover:bg-emerald-500 text-white transition-all shadow-[0_0_15px_rgba(16,185,129,0.5)] backdrop-blur-md text-xs md:text-sm font-medium"
        >
